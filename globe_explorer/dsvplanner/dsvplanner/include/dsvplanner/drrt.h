...
namespace dsvplanner_ns
{
    ...
    {
    public:
        Drrt(rclcpp::Node::SharedPtr &node_handle, octomanager *manager, DualStateGraph *graph, DualStateFrontier *frontier);
        ~Drrt();
    ...
    protected:
        ...
        octomanager *manager_; // octomap管理器
        DualStateGraph *dual_state_graph_;
        DualStateFrontier *dual_state_frontier_;

        rclcpp::Node::SharedPtr nh_;

        // rclcpp::Publisher<sensor_msgs::msg::PointCloud2>::SharedPtr node_pub_;
    };
}
